...
*/
BitMap* GlobalFreeMap;//全局空闲块管理
BitMap* GlobalSpaceId;//管理全局空间标识
int gh;
#endif
...
Initialize(int argc, char **argv)
{
    ...
    GlobalFreeMap = new BitMap(NumPhysPages);//全局空闲块管理
    GlobalSpaceId = new BitMap(NumPhysPages);//管理全局空间标识
    gh=1000;
#endif
